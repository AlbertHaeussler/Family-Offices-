...
window.FO_DATA = (window.FO_DATA || []).concat([
  ...
  {
    id:"roechling_immo",
    name:"Röchling Immobilien (Familie Röchling, München)", kurz:"Röchling Immobilien",
    typ:"SFO",
    land:"Deutschland",
    hqAddress:"Theresienstraße 40, 80333 München",
    hqLat:48.1489, hqLng:11.5680,
    website:"", domain:"",
    linkedin:"", contactName:"Cristopher Röchling", contactRole:"Geschäftsführer", contactChannel:"",
    contactLinkedin:"", contactLinkedinName:"",
    category:"gelb",
    aum:{ value:0.5, unit:"Mrd €", basis:"extrapolation", note:"Reine Einschätzung — Familie Röchling gesamt ~3,4 Mrd € (Kunststoffkonzern Röchling SE = operativ, hier NICHT gemeint). Münchner private RE-Verwaltung (Röchling Immobilien GmbH & Co. KG 'Mauerkircher Straße', HRA 87237 AG München). ACHTUNG: Familienbezug plausibel (Name + GF), aber nicht 100 % durch eine Quelle bestätigt.", sources:[{label:"Creditreform",url:"https://firmeneintrag.creditreform.de/80333/8170725250/ROECHLING_IMMOBILIEN_GMBH_CO_KG_MAUERKIRCHER_STRASSE"}] },
