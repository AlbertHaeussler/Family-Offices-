/* =========================================================================
   Family Offices - Datensatz (NUR echte Family Offices)
   Stand: 07/2026
   -------------------------------------------------------------------------
   Jede Schaetzung traegt Quellen: sources:[{label,url}]
   basis:"extrapolation" = reine Einschaetzung ohne Einzelquelle
   basis:"quelle" = belegt
   confirmedObjects = exakte Adresse (scharfe Pins) · heatmap = Regionen
   category: 'gruen' grosses RE · 'gelb' minimal/<10% aber Interesse · 'rot' keins
   ========================================================================= */
...
window.FO_DATA = [
  ...
  },
  {
    ...
    "aum": {
      ...
      "sources": [
        {
          "label": "Bayerische Hausbau – Unternehmen",
          "url": "https://www.hausbau.de/unternehmen/schoerghuber-unternehmensgruppe"
        },
        {
          "label": "Wikipedia – Bayerische Hausbau",
          "url": "https://de.wikipedia.org/wiki/Bayerische_Hausbau"
        }
      ]
    },
    "reQuote": {
      ...
      "sources": [
        {
          "label": "Bayerische Hausbau",
          "url": "https://www.hausbau.de/"
        }
      ]
    },
    "reInvestedEUR": 3.3,
    ...
    "confirmedObjects": [
      {
        "name": "Objekt Marienplatz 22",
        "address": "Marienplatz 22, 80331 München",
        "lat": 48.1369,
        "lng": 11.576,
        "usage": "Retail",
        "area": "Altstadt-Toplage",
        "purchaseDate": "Bestand",
        "valueEUR": 150,
        "status": "Bestand",
        "images": [],
      ...
      {
        "name": "Objekt Kaufingerstraße 15",
      ...
      {
        "name": "Joseph-Pschorr-Haus",
        "address": "Neuhauser Straße 9, 80331 München",
        "lat": 48.1382,
        "lng": 11.57,
        "usage": "Retail",
        "area": "Altstadt-Toplage",
      ...
      {
        "name": "Donisl",
        "address": "Weinstraße 1, 80331 München",
        "lat": 48.1376,
        "lng": 11.5748,
        "usage": "Gastro",
        "area": "Traditionsgaststätte",
        "purchaseDate": "Bestand",
        "valueEUR": 40,
        "status": "Bestand",
        "images": [],
      ...
      {
        "name": "BIKINI Berlin (entwickelt, lt. Presse verkauft)",
        "address": "Budapester Straße 38–50, 10787 Berlin",
        "lat": 52.506,
        "lng": 13.338,
        "usage": "Buero",
        "area": "Ensemble Büro/Retail/Hotel",
        "purchaseDate": "entwickelt bis 2014",
        "valueEUR": 300,
        "status": "Verkauft",
        "images": [],
        "sources": [
          {
            "label": "Wikipedia – Bikini-Haus",
            "url": "https://de.wikipedia.org/wiki/Bikini-Haus"
          }
        ]
      }
    ],
    "heatmap": [
      {
        ...
        "sources": [
          {
            "label": "Bayerische Hausbau – Ankauf (ab 5.000 m², München)",
            "url": "https://www.hausbau.de/unternehmen/ankauf"
          }
        ]
      },
      {
        ...
        "sources": [
          {
            "label": "Bayerische Hausbau – Bikini Berlin",
            "url": "https://www.hausbau.de/"
          }
        ]
      }
  ...
  {
    "id": "hurler",
    "name": "Jost Hurler Beteiligungs- und Verwaltungs GmbH & Co. KG",
    "kurz": "Jost Hurler",
    "typ": "SFO",
    "land": "Deutschland",
    "hqAddress": "Leopoldstraße 184, 80804 München",
    "hqLat": 48.179,
    "hqLng": 11.586,
    "website": "jost-hurler.de",
    "domain": "jost-hurler.de",
    "linkedin": "",
    "contactName": "Jost Hurler Immobilienmanagement GmbH",
    "contactRole": "Immobilienmanagement / Ankauf",
    "contactChannel": "über jost-hurler.de · Leopoldstr. 184, 80804 München",
    "category": "gruen",
    "aum": {
      "value": 2,
      "unit": "Mrd €",
      ...
      "sources": [
        {
          "label": "Wikipedia – Jost Hurler",
          "url": "https://de.wikipedia.org/wiki/Jost_Hurler"
        }
      ]
    },
    "reQuote": {
      ...
      "sources": [
        {
          "label": "Jost Hurler",
          "url": "https://www.jost-hurler.de/en/"
        }
      ]
    },
    "reInvestedEUR": 1.8,
    ...
    "confirmedObjects": [
      {
        "name": "HUMA Einkaufswelt",
        "address": "Thomas-Dehler-Straße, 81737 München (Neuperlach)",
        "lat": 48.101,
        "lng": 11.641,
        "usage": "Retail",
        "area": "~90.000 m² (nach Neubau)",
        "purchaseDate": "Bestand",
        "valueEUR": 300,
        "status": "Bestand",
        "images": [],
  ...
  {
    "id": "doblinger",
    "name": "Doblinger Beteiligung GmbH (Doblinger Unternehmensgruppe)",
    "kurz": "Doblinger",
    "typ": "SFO",
    "land": "Deutschland",
    ...
    "hqLat": 48.2095,
    "hqLng": 11.576,
    "website": "doblinger-unternehmensgruppe.de",
    "domain": "doblinger-unternehmensgruppe.de",
    "linkedin": "",
    "contactName": "Familie/Unternehmensgruppe Doblinger (gegr. Alfons Doblinger)",
    "contactRole": "Immobilien / Bestandshaltung",
    "contactChannel": "über doblinger-unternehmensgruppe.de",
    "category": "gruen",
    "aum": {
      "value": 8,
      "unit": "Mrd €",
      ...
      "sources": [
        {
          "label": "Rosa-Luxemburg-Stiftung",
          "url": "https://www.rosalux.de/news/id/52100/doblinger-das-wertvollste-immobilienvermoegen"
        },
        {
          "label": "Wikipedia – Doblinger",
          "url": "https://de.wikipedia.org/wiki/Doblinger_Unternehmensgruppe"
        }
      ]
    },
    "reQuote": {
      ...
      "sources": [
        {
          "label": "Doblinger Unternehmensgruppe",
          "url": "https://www.doblinger-unternehmensgruppe.de/"
        }
      ]
    },
    "reInvestedEUR": 7,
    ...
    "confirmedObjects": [
      {
        "name": "Kaufhof-/Galeria-Gebäude am Marienplatz",
        "address": "Kaufingerstraße 1–5, 80331 München",
        "lat": 48.1372,
        "lng": 11.5745,
        "usage": "Retail",
        "area": "Warenhaus-Immobilie (Toplage)",
        "purchaseDate": "Bestand",
        "valueEUR": 400,
        "status": "Bestand",
        "images": [],
        "sources": [
          ...
          {
            "label": "Abendzeitung München",
            "url": "https://www.abendzeitung-muenchen.de/muenchen/bayernlb-verkauft-luxusbauten-an-doblinger-und-benko-entstehen-wohnungen-art-838859"
          }
        ]
      }
    ],
